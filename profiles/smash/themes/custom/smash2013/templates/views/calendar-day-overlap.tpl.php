...
<div id="single-day-container">
  ...
  <table class="full">
    <tbody>
      ...
      <tr>
        <?php $agenda_hour_started = FALSE; ?>
        <td class="first">
          <?php $is_first = TRUE; ?>
          <?php foreach ($rows['items'] as $time_cnt => $hour): ?>
            <?php 
              if (empty($hour['values']) && !$agenda_hour_started) continue;
              if (!empty($hour['values'])) $agenda_hour_started = TRUE;
        ...
        <?php $agenda_items_started = FALSE; ?>
        <td class="last">
          <?php foreach ($rows['items'] as $time_cnt => $hour): ?>
            <?php 
              if (empty($hour['values']) && !$agenda_items_started) continue;
              if (!empty($hour['values'])) $agenda_items_started = TRUE;
